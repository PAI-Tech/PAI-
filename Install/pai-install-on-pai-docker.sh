...
# pai-install Bot on PAI dockers
# PAI OS for Linux
# pai-script-id=3C3F2ED5-C28A-40EF-835E-9D93B8502C8E
...
PAI_SCRIPT_ID=3C3F2ED5-C28A-40EF-835E-9D93B8502C8E

#. ./pai.sh

# PAI functions

pai_3C3F2ED5-C28A-40EF-835E-9D93B8502C6E_intro() {
...
pai_3C3F2ED5-C28A-40EF-835E-9D93B8502C8E_end() {
	echo ""
	echo -e 'done :)'
}
