...
# Created by Tamir Fridman on Mon Nov 12 18:01:48 IDT 2018
...
pai_bot_install()
{
	...
	pai_log 'Installing Bot proccess'
        echo ""
        echo "Git clone"
        git clone https://github.com/PAI-Tech/PAI-BOT-JS.git $PAI_BOT_FOLDER/
        echo ""
        echo "npm install"
        npm install $PAI_BOT_FOLDER/PAI-BOT-JS --prefix $PAI_BOT_FOLDER/PAI-BOT-JS
        echo ""
        echo "Installing Bot"
        node $PAI_BOT_FOLDER/PAI-BOT-JS/PAI_init.js
        pm2 start $PAI_BOT_FOLDER/PAI-BOT-JS/PAI.js"
        echo "success"
}
